...
**Identification Data:** We collect your email address (if provided), name or nickname you provide when creating your account, password you set, the telephone number and name of the emergency contact you provide (if any), and unique identifiers assigned by third party platforms (such as analytics or subscription management tools).

**Stats Page Data:** We collect information relating to your account stats, such as the number of exercises completed, breathing sessions, grounding techniques used, and time spent using the app's various tools.
...
**Log Data:** Information that your device automatically sends whenever you use the App. Log Data includes your Internet Protocol address, device type and settings, the date and time of your request, and how you interacted with the App.

**Cookies Data:** While our mobile app does not use cookies, our website (if applicable) may use cookies as described in the "Cookies" section below.
