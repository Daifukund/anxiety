...
(h) You will not, without authorization, access, tamper with, or use non-public areas of the Products, Nuvin's computer systems, or the technical delivery systems of Nuvin's providers.

(i) Except as necessary to maintain your own computer security by use of commercial-off-the-shelf anti-virus or anti-malware products, you will not attempt to probe, scan, or test the vulnerability of the Products or any other Nuvin system or network or breach any security or authentication measures.
...
(d) Tamper with the Products or circumvent any technology used by Nuvin or its licensors to protect any content accessible through the Products;
...
**By E-Mail:** nathan.douziech@gmail.com
**Subject line:** DMCA
